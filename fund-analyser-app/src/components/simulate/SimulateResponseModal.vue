      ...
      .row.q-col-gutter-x-md
        .col-4
          q-list
            ...
            q-item Funds:
          q-table(dense :rows="funds" :columns="queryColumns" row-key="isin"
...
.holdings-history-table .q-table__top,
.holdings-history-table .q-table__bottom,
.holdings-history-table thead tr:first-child th {
