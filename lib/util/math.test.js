...
describe('math', function () {
    ...
    describe('closestRecord', function () {
        ...
        it('should find closest records', function () {
            assert.isNull(math.closestRecord('5Y', historicPrices));
            assert.isNull(math.closestRecord('3Y', historicPrices));
            assert.isNull(math.closestRecord('1Y', historicPrices));
            assert.isNull(math.closestRecord('6M', historicPrices));
            assert.isNull(math.closestRecord('3M', historicPrices));
            assert.isNull(math.closestRecord('1M', historicPrices));
            assert.isTrue(
                _.isEqual(math.closestRecord('2W', historicPrices),
                    new Fund.HistoricPrice(new Date(2017, 3, 10), 486.0)));
            assert.isTrue(
    ...
    describe('calcPercentiles', function () {
        ...
        it('should calc correct percentiles', function () {
            ...
            expect(newReturns).to.not.have.property('1M');
            expect(newReturns).to.have.property('2W', (469 - 467) / (486 - 467));
