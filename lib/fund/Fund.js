...
function Fund(isin, name, type, shareClass, frequency, ocf, amc, entryCharge, exitCharge, holdings, historicPrices, returns) {
    this.isin = isin;
    this.name = name;
    this.type = type;
...
FundBuilder.prototype.build = function () {
    return new Fund(this._isin, this._name, this._type, this._shareClass, this._frequency,
        this._ocf, this._amc, this._entryCharge, this._exitCharge, this._holdings, this._historicPrices, this._returns);
};
