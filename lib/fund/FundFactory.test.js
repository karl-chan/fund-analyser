...
describe('FundFactory', function () {
    ...
    it('getFunds should return array of funds', function (done) {
        ...
        sinon.stub(fundFactory.fundPostprocessor, 'postprocess')
    ...
    it('streamFunds should return a Transform stream outputting array of funds', function (done) {
        ...
        const fundPostprocessingStream = new stream.Transform({
            objectMode: true,
            transform(chunk, encoding, callback) {
                callback(null, chunk);
            }
        ...
        sinon.stub(fundFactory.fundPostprocessor, 'stream')
            .returns(fundPostprocessingStream);
